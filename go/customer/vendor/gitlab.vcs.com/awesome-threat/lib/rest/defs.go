...
const (
	Module = "REST"
	// Auth
	TypeAuthenticateNone      = "none"
	TypeAuthenticateBasicAuth = "basic"
	TypeAuthenticateToken     = "token"
	// Status
	...
	MIMEApplicationXWWWFormURLEncode     = "application/x-www-form-urlencoded"
...
var (
	...
	contentTypes = []string{
		MIMEApplicationXWWWFormURLEncode,
		MIMEApplicationJSON,
