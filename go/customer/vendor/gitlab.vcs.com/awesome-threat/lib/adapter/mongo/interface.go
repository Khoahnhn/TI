...
type Database interface {
	...
	FindMany(database, collection string, query *bson.M, sorts []string, offset, size int64, results interface{}) (int64, error)
	...
	AggregationCount(database, collection string, query *bson.M, fields []string) (map[string][]ResultAggregationCount, error)
